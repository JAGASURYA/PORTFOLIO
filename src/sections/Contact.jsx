...
const contactInfo = [
  { icon: Mail,   label: "Email",    value: "jagasurya.h@gmail.com",       href: "mailto:jagasurya.h@gmail.com" },
  { icon: Phone,  label: "Phone",    value: "+91 85906 98108",              href: "tel:+918590698108" },
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div ref={headerRef} className="scroll-hidden text-center max-w-3xl mx-auto mb-10 sm:mb-16">
          ...
          <p className="text-muted-foreground text-sm sm:text-base">
            Actively seeking opportunities in web development and machine learning, open to relevant roles and professional discussions.
          </p>
        </div>

        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 max-w-5xl mx-auto">
          <div ref={formRef} className="scroll-hidden glass p-6 sm:p-8 rounded-3xl border border-primary/30">
          ...
          <div ref={infoRef} className="scroll-hidden space-y-4 sm:space-y-6">
            <div className="glass rounded-3xl p-6 sm:p-8">
              <h3 className="text-lg sm:text-xl font-semibold mb-4 sm:mb-6">Contact Information</h3>
              <div className="space-y-3 sm:space-y-4">
                {contactInfo.map((item, i) => (
                  <a key={i} href={item.href} className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl hover:bg-surface transition-colors group">
            ...
            <div className="glass rounded-3xl p-6 sm:p-8 border border-primary/30">
              ...
              <p className="text-muted-foreground text-xs sm:text-sm">
                I am actively seeking opportunities in web development and machine learning, including full-time roles and freelance projects, where I can apply my skills and contribute to impactful real-world solutions.
              </p>
            </div>
          </div>
        </div>
